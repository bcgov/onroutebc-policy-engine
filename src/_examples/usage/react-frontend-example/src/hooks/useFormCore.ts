...
export const useFormCore = ({ onSubmit, selectedTrailers, axleConfigurations }: UseFormCoreProps) => {
  ...
  const expandSectionsWithErrors = useCallback((errors: any, setCollapsedSections: (updater: (prev: Set<string>) => Set<string>) => void) => {
